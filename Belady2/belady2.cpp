...
int main(int argc, char* argv[]) {
    ...
    // print results
    printRes(trace, "Belady2Forward "+std::to_string(cacheSize)+" "+std::to_string(sampleSize));
    ...
    // print results
    printRes(trace, "Belady2Backward "+std::to_string(cacheSize)+" "+std::to_string(sampleSize));
